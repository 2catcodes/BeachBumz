...
const ABOUTPAGE_JSON = {
  "@context": "https://schema.org",
  "@type": "AboutPage",
  "@id": `${ABOUT_URL}#aboutpage`,
  "url": ABOUT_URL,
  "name": "About Beach Bumz Pub & Pizzeria",
...
const About = () => {
  ...
  return (
    <>
      <SEO
        title="About | Beach Bumz Pub & Pizzeria"
        description="Our story in Morehead City, NC. Community, coastal spirit, and comfort food since 2018."
        path="/about"
      ...
      />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(BREADCRUMBS_JSON) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(ABOUTPAGE_JSON) }} />
